        ...
        <tbody>
            @foreach ($cars as $car)
                <tr>
                    ...
                    <td style="padding-left:30px"><a href="{{ route('admin.car.show',['id'=>$car->id]) }}" class="btn btn-secondary">Show</a></td>
                    <td>
                        <a href="{{ route('admin.car.edit',['id'=>$car->id]) }}" class="btn  btn-primary">
                            Edit
                        </a>
                    </td>
                    ...
                    <td style="padding-left:30px">
                        @if ($car->is_approved==0)
                        <a href="{{ route('admin.car.destroy',['id'=>$car->id]) }}" class="btn btn-danger">Decline</a>
                        @else
