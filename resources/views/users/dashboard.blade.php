										...
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													...
													<a href="{{ route('house.pending') }}"><h4 class="card-title">{{ $pending_houses }}</h4></a>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
												    ...
												    <a href="{{ route('car.pending') }}"><h4 class="card-title">{{ $pending_cars }}</h4></a>
												</div>
											</div>
										</div>
									</div>
