...
<div class="container-fluid">
    <div class="row">
        <div class="col-8">
                <h5 class="text-center" style="padding:20Px" >Edit Post</h5>
                <form action="{{ route('car.update',['id'=>$car->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row" style="padding-left:30px">
                        <div class="form-group col-md-6" style="padding-right:30px">
                            ...
                            <input type="text" name="model" value="{{ $car->model }}" class="form-control" id="model">
                        </div>
                        <div class="form-group col-md-6" style="padding-right:30px">
                    ...
                    <div class="form-row" style="padding-left:30px">
                        <div class="form-group col-md-6" style="padding-right:30px">
                            ...
                            <input type="text" name="price" value="{{ $car->price }}" class="form-control" id="price">
                        </div>
                        <div class="form-group col-md-6" style="padding-right:30px">
                            <label for="price_type">Price Type</label>
                            <select id="price_type" name="price_type" class="form-control">
                                <option selected>Negotianble</option>
                                <option>Fixed</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-row" style="padding-left:30px">
                        <div class="form-group col-md-6" style="padding-right:30px">
                            ...
                            <input type="text" name="year" value="{{ $car->year }}" class="form-control" id="year">
                        </div>
                        <div class="form-group col-md-6" style="padding-right:30px">
                    ...
                    <div class="form-row" style="padding-left:30px">
                        <div class="form-group col-md-6" style="padding-right:30px">
                            ...
                            <input type="text" name="mileage" value="{{ $car->mileage }}" class="form-control" id="mileage">
                        </div>
                        <div class="form-group col-md-6" style="padding-right:30px">
                    ...
                    <div class="form-row" style="padding-left:30px">
                        <div class="form-group col-md-6" style="padding-right:30px">
                            ...
                            <input type="text" name="phone" value="{{ $car->phone }}" class="form-control" id="phone">
                        </div>
                        <div class="form-group col-md-6" style="padding-right:30px">
                            <label for="description">Description</label>
                            <textarea name="description" id="" cols="30" rows="5" class="form-control">{{ $car->description }}</textarea>
                        </div>
                    </div>
                ...
                <div class="container-fluid pb-4">
                    <section id="timeline" class="section">
                            ...
                            <ol class="timeline timeline-horizontal">
                                ...
                                <p>Make payment to bank account (). 300 Birr for one month.</p>
                                </li>
